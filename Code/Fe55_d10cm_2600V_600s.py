...
data = open('../Data/April-25_Data/Fe55_d10cm_2600V_600s.Spe','r')
data_counts = spe_file_read(data)
channels = np.arange(0,16384,1)

data1 = open("../Data/April-25_Data/Background_d10cm_2600V_600s.Spe",'r')
...
guess = [4550, 320, 20, 9650, 2410, 2000]
